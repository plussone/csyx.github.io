window.skins=window.skins||{};
                ...
                generateEUI.skins = {"eui.Button":"resource/eui_skins/ButtonSkin.exml","eui.CheckBox":"resource/eui_skins/CheckBoxSkin.exml","eui.HScrollBar":"resource/eui_skins/HScrollBarSkin.exml","eui.HSlider":"resource/eui_skins/HSliderSkin.exml","eui.Panel":"resource/eui_skins/PanelSkin.exml","eui.TextInput":"resource/eui_skins/TextInputSkin.exml","eui.ProgressBar":"resource/eui_skins/ProgressBarSkin.exml","eui.RadioButton":"resource/eui_skins/RadioButtonSkin.exml","eui.Scroller":"resource/eui_skins/ScrollerSkin.exml","eui.ToggleSwitch":"resource/eui_skins/ToggleSwitchSkin.exml","eui.VScrollBar":"resource/eui_skins/VScrollBarSkin.exml","eui.VSlider":"resource/eui_skins/VSliderSkin.exml","eui.ItemRenderer":"resource/eui_skins/ItemRendererSkin.exml","maps":"resource/skins/maps.exml","new_map":"resource/eui_skins/new_map.exml","daoju":"resource/eui_skins/daoju.exml","chengjiu":"resource/eui_skins/chengjiu.exml","rengwu":"resource/eui_skins/rengwu.exml","jingdian":"resource/eui_skins/jingdian.exml"};generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	function daojuSkin() {
		_super.call(this);
		this.skinParts = ["b1","background","jiasuka","xianlupifu1","tpf1","tpfx1","xianlupifu2","tpf2","tpfx2","xianlupifu3","tpf3","tpfx3","xianlupifu4","tpf4","tpfx4","xianlupifu5","tpf5","tpfx5","t2","t1","bpf1","bpf2","bpf3","bpf4","bpf5","b2"];
		
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this._Image1_i(),this.b1_i(),this._Scroller1_i(),this._Label1_i()];
	}
	...
	_proto._Group1_i = function () {
		...
		t.anchorOffsetX = 0;
		t.width = 932;
		t.elementsContent = [this.background_i(),this.jiasuka_i(),this.xianlupifu1_i(),this.tpf1_i(),this.tpfx1_i(),this.xianlupifu2_i(),this.tpf2_i(),this.tpfx2_i(),this.xianlupifu3_i(),this.tpf3_i(),this.tpfx3_i(),this.xianlupifu4_i(),this.tpf4_i(),this.tpfx4_i(),this.xianlupifu5_i(),this.tpf5_i(),this.tpfx5_i(),this.t2_i(),this.t1_i(),this.bpf1_i(),this.bpf2_i(),this.bpf3_i(),this.bpf4_i(),this.bpf5_i(),this.b2_i()];
		return t;
	};
	...
	var jingdianSkin$Skin2 = 	(function (_super) {
		__extends(jingdianSkin$Skin2, _super);
		function jingdianSkin$Skin2() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = jingdianSkin$Skin2.prototype;
	...
	var rengwuSkin$Skin119 = 	(function (_super) {
		__extends(rengwuSkin$Skin119, _super);
		function rengwuSkin$Skin119() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = rengwuSkin$Skin119.prototype;
